 ...
 * @date 2015-10-19
 */
public class PageResolver_Ruc_Doc extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Ruc_Doc.class);
	public PageResolver_Ruc_Doc(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		if(ne.getNews_content().contains("作者是")) {
			newsAuthor = newsAuthor.substring(newsAuthor.indexOf("作者是") + 3);
