...
public class PageCrawler_XingJiang extends PageCrawler {
	
	public static final String TODAY = new SimpleDateFormat("yyyy-MM-dd").format(new Date());

	public PageCrawler_XingJiang(TaskLink link, Task task) {
		super(link, task);
	}
	...
	protected String getPageContent() {
		...
		WebPageDownloaderXINJIANG downloader = new WebPageDownloaderXINJIANG(downloadUrl);
