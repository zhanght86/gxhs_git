...
/**
 * 中国环境科学研究院的正文信息,其中包括pdf文件 与docx文件 
 * @author dingrr
 * @date 2015-10-19
 */
public class PageResolver_Craes extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Craes.class);
	public PageResolver_Craes(Task task) {
		super(task);
	}
