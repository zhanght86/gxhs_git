 ...
 * @date 2015-10-7
 */
public class PageResolver_IjsCass extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_IjsCass.class);
	public PageResolver_IjsCass(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		if(newsAuthor.contains("作者：")) {
			newsAuthor = newsAuthor.substring(newsAuthor.indexOf("作者：") + 3,newsAuthor.indexOf("来源"));
		} else {
			newsAuthor = "";
		}
