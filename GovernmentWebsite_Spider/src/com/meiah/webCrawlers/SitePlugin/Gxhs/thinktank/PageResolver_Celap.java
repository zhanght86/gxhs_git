 ...
 * @date 2015-10-19
 */
public class PageResolver_Celap extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Celap.class);

	public PageResolver_Celap(Task task) {
		super(task);
	}
