...
public class PageResolver_Xjjsxx extends PageResolver_General {
	
	public PageResolver_Xjjsxx(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		if(!newsImage.isEmpty()){
			if(newsImage.contains("http://www.xjjsxx.gov.cn/xjweb/images/wybm.jpg"))
				newsImage.remove("http://www.xjjsxx.gov.cn/xjweb/images/wybm.jpg");
