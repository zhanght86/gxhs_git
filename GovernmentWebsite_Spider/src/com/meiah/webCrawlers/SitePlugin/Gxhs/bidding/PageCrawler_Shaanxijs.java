...
public class PageCrawler_Shaanxijs extends PageCrawler {
	
	public static final String TODAY = new SimpleDateFormat("yyyy-MM-dd").format(new Date());

	public PageCrawler_Shaanxijs(TaskLink link, Task task) {
		super(link, task);
	}
	...
	protected String getPageContent() {
		...
		WebPageDownloaderSHAAnxijs downloader = new WebPageDownloaderSHAAnxijs(downloadUrl);
