 ...
 *
 */
public class PageCrawler_Jlin extends PageCrawler {
	
	protected static Map<String,String> columnUrl = new HashMap<String,String>();
	
	public PageCrawler_Jlin(TaskLink link, Task task) {
		super(link, task);
	}
	...
	protected void mainPro() {
		for(int i=1;i<70;i++){
			columnUrl.put("http://jilinbidding.changchun.gov.cn/zbgs/index_"+i+".html" , "中标公示");
			columnUrl.put("http://jilinbidding.changchun.gov.cn/zbgs/index_"+i+".html" , "招标公告");
		}
