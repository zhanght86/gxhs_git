...
import com.meiah.util.CharsetDetector;
import com.meiah.util.JavaUtil;
import com.meiah.util.WebPageDownloader;

/**
 * 近代中国研究网等不需要代理ip的网站网页下载类
 * 
 * @author dingrr
 * @Date 2015年12月3日
 */
public class WebPageDownloadeGbk extends WebPageDownloader{
	public WebPageDownloadeGbk(String url) {
		super(url);
	}
...
//				tempUrl = JavaUtil.encodeURL(tempUrl);
	...
	public static String big5ToChinese( String s )
	{
	    try{
	        ...
	        newstring = new String( s.getBytes( "GBK" ), "gb2312" );
	        return(newstring);
	    }
