...
import com.meiah.webCrawlers.SitePlugin.Gxhs.finance.WebPageDownloadeGbk;

public class PageCrawler_GBK extends PageCrawler {
	
	public static final String TODAY = new SimpleDateFormat("yyyy-MM-dd").format(new Date());

	public PageCrawler_GBK(TaskLink link, Task task) {
		super(link, task);
	}
