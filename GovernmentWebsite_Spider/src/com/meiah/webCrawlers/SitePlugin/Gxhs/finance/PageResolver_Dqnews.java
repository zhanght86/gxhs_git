...
public class PageResolver_Dqnews extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Dqnews.class);
	
	public PageResolver_Dqnews(Task task) {
		super(task);
	}
