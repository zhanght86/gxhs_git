...
public class PageResolver_Dy88 extends PageResolver_General {
	
	public PageResolver_Dy88(Task task) {
		super(task);
	}
...
//		}
		ne.setNews_content(StringUtils.replaceEach(content, new String[] { "\n","\r\n","　","&#160;","&ldquo;","&lsquo;","&rsquo;","&rdquo;","&lambda;"}, new String[] { "", "" ,"", "", "" ,"", "", "" ,""}).trim());
		...
		if(StringUtils.isNotBlank(newsAuthor))
			ne.setNews_author(StringUtils.replaceEach(newsAuthor, new String[] { "等", "撰写","作者：","作者:"," ","?","哈尔滨市" ,"水目标到"}, new String[] { "", "" ,"", "" ,"" , "","",""}));
