...
public class PageResolver_Dbw extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Dbw.class);
	
	public PageResolver_Dbw(Task task) {
		super(task);
	}
