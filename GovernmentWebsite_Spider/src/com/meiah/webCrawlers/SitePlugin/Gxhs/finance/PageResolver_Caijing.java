...
public class PageResolver_Caijing extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Caijing.class);
	
	public PageResolver_Caijing(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
	...
	public static void main(String[] args) {
		String content = "有意与本刊合作者，有关合作事宜请与财经网联系。未经财经网书面授权，请勿转载或建立镜像，否则即为侵权。";
	}
}
