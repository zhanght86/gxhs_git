...
public class PageResolver_GjsCass extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_GjsCass.class);
	
	public PageResolver_GjsCass(Task task) {
		super(task);
	}
