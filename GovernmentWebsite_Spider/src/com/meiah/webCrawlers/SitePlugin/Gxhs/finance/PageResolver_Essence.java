...
public class PageResolver_Essence extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Essence.class);
	
	public PageResolver_Essence(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		content = content.replaceAll("您好，安信证券欢迎您！客户中心|信息修改|退出您好，安信证券欢迎您！用户名用户名资金账号股东代码保存账号若您是交易用户第一次登录，请先注册", "")
				.replaceAll("||退出您好，安信证券欢迎您！用户名用户名资金账号股东代码保存账号若您是交易用户第一次登录，请先注册★", "");
