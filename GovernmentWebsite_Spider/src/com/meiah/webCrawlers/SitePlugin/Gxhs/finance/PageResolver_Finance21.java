...
public class PageResolver_Finance21 extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Finance21.class);
	
	public PageResolver_Finance21(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		if(ne.getNews_content().startsWith("用户中心 | 免费邮箱 |") || ne.getNews_content().startsWith("责任编辑：")) {
			ne = null;
		}
		return ne;
	}
