...
public class PageResolver_Caixin extends PageResolver_General {
	
	public PageResolver_Caixin(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		String[] newsSourceArray=newsSource.split("于\r\n");
		newsSource = newsSourceArray[1];
		...
		if(StringUtils.isNotBlank(newsAuthor))
			ne.setNews_author(StringUtils.replaceEach(newsAuthor, new String[] { "等", "撰写","作者：","作者:"," ","?","【财新网】","（记者","）","\r\n","（","见习记者","实习记者","财新记者","驻纽约记者","驻香港记者"}, new String[] {"","","","", "" ,"" , "","", "" ,"" , "","","","","",""}));
