 ...
 * @date 2015-10-7
 */
public class PageResolver_Cycs extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Cycs.class);
	public PageResolver_Cycs(Task task) {
		super(task);
	}
