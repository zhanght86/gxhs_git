 ...
 * @Date 2015年12月3日
 */
public class WebPageDownloaderUseProxy extends WebPageDownloader{
	public WebPageDownloaderUseProxy(String url) {
		super(url);
	}
	...
	public String getPageContent() throws Exception {
		...
		for (int i = 0; i < 5; i++) {
			...
			try {
				...
				_http.getClientHeaders().add(new Attribute("Connection", "keep-alive"));
