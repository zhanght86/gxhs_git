...
public class PageCrawler_Xzzbtb extends PageCrawler {
	
	public static final String TODAY = new SimpleDateFormat("yyyy-MM-dd").format(new Date());

	public PageCrawler_Xzzbtb(TaskLink link, Task task) {
		super(link, task);
	}
	...
	protected String getPageContent() {
		...
		WebPageDownloaderXzzbtb downloader = new WebPageDownloaderXzzbtb(downloadUrl);
