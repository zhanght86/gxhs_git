...
public class PageResolver_EastMoney extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_EastMoney.class);
	
	public PageResolver_EastMoney(Task task) {
		super(task);
	}
