...
public class PageCrawler_Tjztb extends PageCrawler {
	
	public static final String TODAY = new SimpleDateFormat("yyyy-MM-dd").format(new Date());

	public PageCrawler_Tjztb(TaskLink link, Task task) {
		super(link, task);
	}
	...
	protected String getPageContent() {
		...
		WebPageDownloaderTJZTB downloader = new WebPageDownloaderTJZTB(downloadUrl);
