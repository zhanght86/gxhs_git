 ...
 * @date 2015-10-19
 */
public class PageResolver_ForPeace extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_ForPeace.class);
	public PageResolver_ForPeace(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		if(StringUtils.isEmpty(ne.getNews_content())) {
			ne = null;
			return ne;
		}
