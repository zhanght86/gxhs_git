 ...
 * @date 2015-10-4
 */
public class PageResolver_Nmgwsg extends PageResolver_General{

	public PageResolver_Nmgwsg(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		if(newsAuthor.contains("未知")) {
			newsAuthor = newsAuthor.substring(newsAuthor.indexOf("未知") + 3);
