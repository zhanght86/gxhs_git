 ...
 * @date 2015-10-19
 */
public class PageResolver_Cdi extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Cdi.class);

	public PageResolver_Cdi(Task task) {
		super(task);
	}
...
//			ne.setIsHomePageNews(1);
		...
		if (newsAuthor.contains("作者：")) {
			newsAuthor = newsAuthor.replaceAll("作者：", "");
		}
