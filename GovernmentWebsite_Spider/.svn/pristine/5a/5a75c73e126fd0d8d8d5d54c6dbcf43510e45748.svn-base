 ...
 * @date 2015-10-7
 */
public class PageResolver_Pangoal extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_Pangoal.class);
	public PageResolver_Pangoal(Task task) {
		super(task);
	}
