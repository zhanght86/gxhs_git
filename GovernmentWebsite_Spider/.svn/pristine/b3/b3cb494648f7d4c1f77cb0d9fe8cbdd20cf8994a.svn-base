 ...
 * @date 2015-10-19
 */
public class PageResolver_CesPku_Doc extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_CesPku_Doc.class);
	public PageResolver_CesPku_Doc(Task task) {
		super(task);
	}
