 ...
 * @Date 2015年12月3日
 */
public class WebPageDownloaderTJZTB extends WebPageDownloader{
	public WebPageDownloaderTJZTB(String url) {
		super(url);
	}
	/**
...
//				tempUrl = StringUtils.substring(tempUrl, 0, tempUrl.lastIndexOf("/"));
