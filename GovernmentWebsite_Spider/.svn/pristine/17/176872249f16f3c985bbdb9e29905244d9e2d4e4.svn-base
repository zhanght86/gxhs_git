 ...
 * @date 2015-10-7
 */
public class PageResolver_HorizonChina extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_HorizonChina.class);
	public PageResolver_HorizonChina(Task task) {
		super(task);
	}
