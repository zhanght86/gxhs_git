 ...
 * 
 */
public class ConnectionsPoolLocal {
	private Logger logger = Logger.getLogger(ConnectionsPoolLocal.class);
	...
	private static ConnectionsPoolLocal connectionsPoolInstance = null;// 返回实例

	/**
	 * 构造函数，初始化基本信息以及连接池
	 */
	public ConnectionsPoolLocal() {
	 ...
	 * @return
	 */
	public synchronized static ConnectionsPoolLocal getInstance() {
		if (connectionsPoolInstance == null) {
			connectionsPoolInstance = new ConnectionsPoolLocal();
		}
	...
	private void initConfig() {
		this.driver = Config.getLocaldriver();
		this.url = Config.getLocalurl();
		this.user = Config.getLocaluser();
		this.pwd = Config.getLocalpassword();
//		logger.info(driver);
//		logger.info(url);
//		logger.info(user);
//		logger.info(pwd);
	...
	public static void main(String[] args) {
		ConnectionsPoolLocal.getInstance();
	}
