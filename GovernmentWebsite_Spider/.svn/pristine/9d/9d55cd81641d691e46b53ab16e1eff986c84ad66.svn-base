 ...
 * @date 2015-10-7
 */
public class PageResolver_TaiWan extends PageResolver_General {
	protected Logger logger = Logger.getLogger(PageResolver_TaiWan.class);
	public PageResolver_TaiWan(Task task) {
		super(task);
	}
